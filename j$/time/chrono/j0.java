...
public final class j0 extends d {
  ...
  public j0(LocalDate paramLocalDate) {
  ...
  public final j0 J(long paramLong, q paramq) {
    LocalDate localDate;
    if (paramq instanceof a) {
      ...
      if (i != 4)
        if (i != 5) {
          ...
          h0.c.t(a).b(paramLong, (q)a);
          long l2 = I();
          long l1 = this.a.getMonthValue();
          return K(this.a.O(paramLong - l2 * 12L + l1 - 1L));
        }  
      i = h0.c.t(a).a(paramLong, (q)a);
      int j = arrayOfInt[a.ordinal()];
      if (j != 4)
        return (j != 6) ? ((j == 7) ? K(this.a.U(-542 - I())) : K(this.a.R(paramLong, paramq))) : K(this.a.U(i - 543)); 
      localDate = this.a;
      if (I() < 1)
        i = 1 - i; 
      return K(localDate.U(i - 543));
    } 
    return (j0)super.h(paramLong, (q)localDate);
  }
  
  public final j0 K(LocalDate paramLocalDate) {
    return paramLocalDate.equals(this.a) ? this : new j0(paramLocalDate);
  }
  ...
  public final boolean equals(Object paramObject) {
    ...
    if (paramObject instanceof j0) {
      ...
      return this.a.equals(((j0)paramObject).a);
    } 
    return false;
  }
...
/* Location:              C:\Users\Kevin\Downloads\dex-tools-v2.4\dex-tools-v2.4\musicolet-dex2jar.jar!\j$\time\chrono\j0.class
