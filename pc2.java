...
public abstract class pc2 {
  ...
  static {
    // Byte code:
    //   0: invokestatic l : ()Lsun/misc/Unsafe;
    //   3: astore #6
    //   5: aload #6
    //   7: putstatic pc2.a : Lsun/misc/Unsafe;
    //   10: getstatic ev2.a : I
    //   13: istore_0
    //   14: ldc libcore/io/Memory
    //   16: putstatic pc2.b : Ljava/lang/Class;
    //   19: getstatic java/lang/Long.TYPE : Ljava/lang/Class;
    //   22: astore #5
    //   24: aload #5
    //   26: invokestatic m : (Ljava/lang/Class;)Z
    //   29: istore_1
    //   30: getstatic java/lang/Integer.TYPE : Ljava/lang/Class;
    //   33: astore #4
    //   35: aload #4
    //   37: invokestatic m : (Ljava/lang/Class;)Z
    //   40: istore_2
    //   41: aconst_null
    //   42: astore_3
    //   43: aload #6
    ...
    //   188: goto -> 92
    //   191: iload_1
    //   192: putstatic pc2.d : Z
    //   195: getstatic pc2.c : Loc2;
    //   198: astore_3
    //   199: aload_3
    //   200: ifnonnull -> 208
    //   203: iconst_0
    ...
    //   440: goto -> 203
    //   443: iload_1
    //   444: putstatic pc2.e : Z
    //   447: ldc [B
    //   449: invokestatic p : (Ljava/lang/Class;)I
    //   452: i2l
    //   453: putstatic pc2.f : J
    //   456: ldc [Z
  ...
  public static Object e(Class<?> paramClass) {
    try {
  ...
  public static int f(long paramLong, Object paramObject) {
    return c.a.getInt(paramObject, paramLong);
  }
  
  public static void g(Object paramObject, long paramLong, int paramInt) {
    c.a.putInt(paramObject, paramLong, paramInt);
  }
  
  public static long h(long paramLong, Object paramObject) {
  ...
  public static Object j(long paramLong, Object paramObject) {
    return c.a.getObject(paramObject, paramLong);
  }
  
  public static void k(long paramLong, Object paramObject1, Object paramObject2) {
  ...
  public static Unsafe l() {
    ...
    try {
      lc2 lc2 = new lc2();
      super();
      Unsafe unsafe = AccessController.<Unsafe>doPrivileged(lc2);
    } finally {
      exception = null;
    } 
    try {
      ...
      Logger.getLogger(pc2.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "getUnsafe", "As part of the planned removal, sun.misc.Unsafe is available in the current environment but configured to throw on use. Protobuf will continue without using it, but with slightly reduced performance. --sun-misc-unsafe-memory-access=allow is likely available to opt back in if desired. A later Protobuf version release will stop using sun.misc.Unsafe entirely.");
      return null;
    } 
  }
  ...
  public static boolean m(Class paramClass) {
    ...
    try {
      ...
      clazz1.getMethod("peekLong", new Class[] { paramClass, clazz2 });
      clazz1.getMethod("pokeLong", new Class[] { paramClass, long.class, clazz2 });
      Class<int> clazz = int.class;
      clazz1.getMethod("pokeInt", new Class[] { paramClass, clazz, clazz2 });
      clazz1.getMethod("peekInt", new Class[] { paramClass, clazz2 });
      clazz1.getMethod("pokeByte", new Class[] { paramClass, byte.class });
      clazz1.getMethod("peekByte", new Class[] { paramClass });
      clazz1.getMethod("pokeByteArray", new Class[] { paramClass, byte[].class, clazz, clazz });
      return true;
    } finally {
      paramClass = null;
    } 
...
/* Location:              C:\Users\Kevin\Downloads\dex-tools-v2.4\dex-tools-v2.4\musicolet-dex2jar.jar!\pc2.class
