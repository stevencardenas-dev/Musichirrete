...
public class HtmlCheckBoxPref extends CheckBoxPreference {
  public HtmlCheckBoxPref(Context paramContext) {
    super(paramContext, null);
    I(null);
  }
  
  public HtmlCheckBoxPref(Context paramContext, AttributeSet paramAttributeSet) {
    super(paramContext, paramAttributeSet);
    I(paramAttributeSet);
  }
  
  public HtmlCheckBoxPref(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    super(paramContext, paramAttributeSet, paramInt, 0);
    I(paramAttributeSet);
  }
  
  public HtmlCheckBoxPref(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2) {
...
/* Location:              C:\Users\Kevin\Downloads\dex-tools-v2.4\dex-tools-v2.4\musicolet-dex2jar.jar!\in\krosbits\pref\HtmlCheckBoxPref.class
