...
public enum Mp4AtomIdentifier {
  ...
  COLR(RqlokDsQOju.QmW, "Specifies the colourspace of the image"),
  ...
  CVRU(kOkiWEITVb.upSS, "OMA DRM Cover URI"),
  DCFD("dcfD", "Marlin DCF Duration, user-data atom type"),
  DINF("dinf", "Data information box, container"),
  DREF(jHxlGgUTadw.oEYgzqN, "Data reference box, declares source(s) of media data in track"),
  ...
  EDTS(fXMDNeMWaILNVh.ItTXQQ, "Edit list container"),
  ...
  IODS("iods", FgdLmmRfTxSFKI.EuUWgOyFUVQNG),
  ...
  ODRB("odrb", ckOPp.vmBgHu),
  ODRM(jLnXOLx.hpxXQ, "OMA DRM Container"),
  ...
  SDVP("sdvp", PwbbJfsdcHrAjW.TIykwfLlDcJmf),
  ...
  private static final Mp4AtomIdentifier[] $VALUES;
  ...
  Mp4AtomIdentifier(String paramString1, String paramString2) {
...
/* Location:              C:\Users\Kevin\Downloads\dex-tools-v2.4\dex-tools-v2.4\musicolet-dex2jar.jar!\org\jaudiotagger\audio\mp4\Mp4AtomIdentifier.class
