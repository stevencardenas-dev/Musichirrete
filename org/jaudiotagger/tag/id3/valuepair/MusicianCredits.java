...
public class MusicianCredits {
  ...
  static {
    ...
    musicianCredits.add(GMDx.vvJItQdd);
    ...
    musicianCredits.add(DJqHMztxflt.qRzRGdLcRYWo);
    ...
    musicianCredits.add(DJqHMztxflt.rQaN);
    ...
    musicianCredits.add(xveccWbRzqx.QVvCk);
    ...
    musicianCredits.add(JkpGFvCVQHzgc.ovEqX);
    ...
    musicianCredits.add(VDgS.MjfTzTQ);
    ...
    musicianCredits.add(DJqHMztxflt.FyoTcNTJexOOY);
    ...
    musicianCredits.add(xveccWbRzqx.EKRmRB);
    ...
    musicianCredits.add(DJqHMztxflt.lETCgJftxFD);
    ...
    musicianCredits.add(nFLlOYeP.nsqwStisTKjQUzj);
    ...
    musicianCredits.add(kOkiWEITVb.USoClXSEZLbony);
    ...
    musicianCredits.add(nBRIsU.iqxc);
    ...
    musicianCredits.add(CKYHNesT.TRumulWDQs);
    ...
    musicianCredits.add(LHyji.FoiGRs);
    ...
    musicianCredits.add(fXMDNeMWaILNVh.XddFhxthMw);
    ...
    musicianCredits.add(KjdXPYm.axW);
    ...
    musicianCredits.add(nFLlOYeP.KSlZnHNkuvW);
    musicianCredits.add(jHxlGgUTadw.gHZG);
    ...
    musicianCredits.add(hrSTyFuSIm.vahh);
    ...
    musicianCredits.add(xveccWbRzqx.QBYBAh);
    ...
    musicianCredits.add(eRUgfgGAccgka.LyXpkQhhcM);
    ...
    musicianCredits.add(RqlokDsQOju.lespuwGxOJrVQ);
    ...
    musicianCredits.add(YbNJ.zFiAAlpt);
    ...
    musicianCredits.add(oXrNDUqUkE.JVvf);
    ...
    musicianCredits.add(oXrNDUqUkE.PGjbahCtZOEcup);
  ...
  public static boolean isKey(String paramString) {
    for (String str : musicianCredits) {
      if (paramString.toLowerCase().trim().startsWith(str))
        return true; 
    } 
    return false;
  }
...
/* Location:              C:\Users\Kevin\Downloads\dex-tools-v2.4\dex-tools-v2.4\musicolet-dex2jar.jar!\org\jaudiotagger\tag\id3\valuepair\MusicianCredits.class
