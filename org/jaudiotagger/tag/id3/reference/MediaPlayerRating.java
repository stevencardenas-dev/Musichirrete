...
public class MediaPlayerRating extends ID3Rating {
  ...
  public int convertRatingToFiveStarScale(int paramInt) {
    return (paramInt <= 0) ? 0 : ((paramInt <= 1) ? 1 : ((paramInt <= 64) ? 2 : ((paramInt <= 128) ? 3 : ((paramInt <= 196) ? 4 : 5))));
  }
}


/* Location:              C:\Users\Kevin\Downloads\dex-tools-v2.4\dex-tools-v2.4\musicolet-dex2jar.jar!\org\jaudiotagger\tag\id3\reference\MediaPlayerRating.class
