...
public final class hw2 extends dv2 implements RandomAccess {
  ...
  static {
    ...
    f = arrayOfObject;
    g = new hw2(arrayOfObject, 0, false);
  }
  
  public hw2(Object[] paramArrayOfObject, int paramInt, boolean paramBoolean) {
    super(paramBoolean);
...
/* Location:              C:\Users\Kevin\Downloads\dex-tools-v2.4\dex-tools-v2.4\musicolet-dex2jar.jar!\hw2.class
